        ...
        <Parallax speed={-0.15}>
          ...
          >
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <motion.p
                className="text-xl md:text-2xl xl:text-3xl text-cyan-300/90 tracking-wide font-medium"
            ...
            >
              <p className="text-base md:text-lg text-gray-300 leading-relaxed max-w-lg font-normal">
            ...
            >
              ...
              >
                ...
                {/* Glow effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-purple-600 blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-300" />
              ...
              <motion.div
                className="flex items-center gap-2 text-xs text-gray-500 ml-2 cursor-pointer font-medium"
                animate={{ y: [0, 6, 0] }}
