                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {projects.map((project) => (
                                ...
                                >
                                    ...
                                    <div
                                        className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#7c3aed]/0 to-[#0ea5e9]/0 group-hover:from-[#7c3aed]/5 group-hover:to-[#0ea5e9]/5 transition-all duration-300"/>
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-start justify-between mb-4">
                                            <div>
                                                ...
                                                <span
                                                    className="text-xs text-white/40 font-mono">{project.language}</span>
                                            </div>
                                            <div
