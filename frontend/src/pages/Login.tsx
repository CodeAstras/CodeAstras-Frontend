            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex items-center justify-between gap-16">
                ...
                <div className="w-full max-w-md">
                    <div className="bg-[#0A0E1A]/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                        {/* Header */}
                        <div className="mb-8">
                            <h2 className="text-3xl font-bold mb-2">Login to CodeAstras</h2>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-white/5 border rounded-xl pl-12 pr-4 py-3 text-white placeholder-[#8892A6] focus:outline-none transition-all ${focusedField === 'email'
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onBlur={() => setFocusedField(null)}
                                        placeholder="••••••••"
                                        className={`w-full bg-white/5 border rounded-xl pl-12 pr-4 py-3 text-white placeholder-[#8892A6] focus:outline-none transition-all ${focusedField === 'password'
                                                ? 'border-[#6B54FF] shadow-[0_0_20px_rgba(107,84,255,0.3)]'
                                                : 'border-white/10'
                                            }`}
                                    />
